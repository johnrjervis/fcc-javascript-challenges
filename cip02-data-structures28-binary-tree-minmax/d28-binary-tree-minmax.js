...
function BinarySearchTree() {
  ...
  this.findMin = () => {
    if (this.root === null) {
      ...
      return this.recursivelyFindMinMax(this.root, "left");
    }
  };
  ...
  this.findMax = () => {
    if (this.root === null) {
      ...
      return this.recursivelyFindMinMax(this.root, "right");
    }
  };

  this.recursivelyFindMinMax = (node, side) => {
    if (node[side] === null) {
      return node.value;
    } else {
      return this.recursivelyFindMinMax(node[side], side);
    }
  };
